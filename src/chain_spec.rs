...
impl Alternative {
    ...
    pub(crate) fn load(self) -> Result<ChainSpec, String> {
        Ok(match self {
            ...
            Alternative::CpiChain => ChainSpec::from_genesis(
                "CPI Chain",
                "cpi_chain",
                || {
                    cpi_chain_genesis(
    ...
    pub(crate) fn from(s: &str) -> Option<Self> {
        match s {
            ...
            "cpi_chain" => Some(Alternative::CpiChain),
            _ => None,
        }
    }
}
...
fn testnet_genesis(
    ...
    GenesisConfig {
		consensus: Some(ConsensusConfig {
			code: include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/cpi_chain_runtime_wasm.compact.wasm").to_vec(),
